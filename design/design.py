...
from chipflow_digital_ip.io import UARTPeripheral, I2CPeripheral
from minerva.core import Minerva
from chipflow_lib.platforms import attach_data, SoftwareBuild, UARTSignature, I2CSignature
...
class MySoC(wiring.Component):
    ...
    def elaborate(self, platform):
        ...
        # I2C 0
        m.submodules.i2c_0 = i2c_0 = I2CPeripheral()
        csr_decoder.add(i2c_0.bus, name="i2c_0", addr=self.csr_i2c_base + 0 * self.periph_offset - self.csr_base)
        connect(m, flipped(self.i2c_0), i2c_0.i2c_pins)
